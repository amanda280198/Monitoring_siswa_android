...
public final class HistoryAsdosIzinBinding implements ViewBinding {
  @NonNull
  private final ConstraintLayout rootView;

  @NonNull
  public final TextView alasanIzin;
  ...
  @NonNull
  public final TextView totalIzin;

  private HistoryAsdosIzinBinding(@NonNull ConstraintLayout rootView, @NonNull TextView alasanIzin,
      @NonNull Button btnAbsen, @NonNull Button btnHadir, @NonNull Button btnIzin,
      @NonNull Button btnKeluar, @NonNull TextView bulan, @NonNull ImageButton buttonBack,
  ...
  @NonNull
  public static HistoryAsdosIzinBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HistoryAsdosIzinBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.history_asdos_izin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HistoryAsdosIzinBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.alasan_izin;
      TextView alasanIzin = rootView.findViewById(id);
      if (alasanIzin == null) {
        break missingId;
      }
      ...
      id = R.id.total_izin;
      TextView totalIzin = rootView.findViewById(id);
      if (totalIzin == null) {
        break missingId;
      }
