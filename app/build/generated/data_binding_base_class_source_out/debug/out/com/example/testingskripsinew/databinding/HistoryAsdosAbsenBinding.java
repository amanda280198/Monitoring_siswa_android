...
public final class HistoryAsdosAbsenBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView totalAbsen;

  @NonNull
  public final TextView txtAbsen;

  private HistoryAsdosAbsenBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAbsen,
  ...
  @NonNull
  public static HistoryAsdosAbsenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HistoryAsdosAbsenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.history_asdos_absen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HistoryAsdosAbsenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.total_absen;
      TextView totalAbsen = rootView.findViewById(id);
      if (totalAbsen == null) {
        break missingId;
      }

      id = R.id.txt_absen;
      TextView txtAbsen = rootView.findViewById(id);
      if (txtAbsen == null) {
        break missingId;
      }
